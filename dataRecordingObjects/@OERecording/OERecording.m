    ...
    methods
        ...
        function [V_uV,t_ms]=getData(obj,channels,startTime_ms,window_ms)
            ...
            for i=1:nWindows
                ...
                singleTrialTimeStamps=obj.allTimeStamps(pSingleTrialTimeStamps{i});
                ...
                pRecIdx{i,:}=timeIdx>=(startTime_ms(i)+0.0000001) & timeIdx<(startTime_ms(i)+0.0000001+window_ms);
                timeIdx=timeIdx';
                pOutIdx{i,1}=round((timeIdx(pRecIdx{i,:}')-startTime_ms(i))/obj.sample_ms)+windowSamples*(i-1); %round should not be changed to floor
            end
        ...
        function obj=extractMetaData(obj)
            ...
            obj.allTimeStamps = obj.allTimeStamps-obj.allTimeStamps(1); %time stamp vector must be a column vector!!!
